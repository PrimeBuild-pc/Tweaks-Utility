...
class NetworkOptimizationScreen extends StatefulWidget {
  ...
  @override
  State<NetworkOptimizationScreen> createState() => _NetworkOptimizationScreenState();
}
        ...
        child: Column(
          ...
          children: [
            ...
            GridView.count(
              ...
              children: [
                _buildNetworkStatCard('Ping', _networkStats['ping'], Icons.speed),
                _buildNetworkStatCard('Jitter', _networkStats['jitter'], Icons.compare_arrows),
                _buildNetworkStatCard('Download', _networkStats['download'], Icons.download),
                _buildNetworkStatCard('Upload', _networkStats['upload'], Icons.upload),
              ],
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CheckboxListTile(
                      ...
                      subtitle: const Text('Optimize TCP/IP stack for lower latency'),
                    ...
                    CheckboxListTile(
                      ...
                      subtitle: const Text('Optimize DNS settings for faster lookups'),
